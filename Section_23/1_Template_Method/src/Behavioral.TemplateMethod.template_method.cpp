...
We have the Game class as the base class with the pure virtual members.

Later, the chess class inherits from this class to implement the specific behaviour.
*/
